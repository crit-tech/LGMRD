module.exports.default = {
  ...
  "sections": [
          ...
          "content": [
            {
              ...
              "table": [
                ...
                [
                  "17",
                  "Adult red dragon",
                  "Mountains, volcanoes, ruins, caverns",
                  "Fire elementals, kobolds"
                ],
                [
                  "17",
                  "Death knight",
                ...
                [
                  ...
                  "Ancient red dragon",
                  "Mountains, volcanoes, ruins, caverns",
                  "Fire giants, fire elementals, kobolds"
                ]
              ]
            }
          ],
      ...
      "subsections": [
        {
          ...
          "content": [
            ...
            },
            {
              "type": "paragraph",
              "order": 0,
              "content": "No battle needs all these things, but it's worth running through the list to see which options fit the sort of combat scenario you're putting together."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Make sure that the battlefield features some interactive objects. This can include any physical features the characters can manipulate and use to their advantage in a fight, including things like the following:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Finally, think about what objective an encounter might have beyond simply taking out all the enemies. What might the characters do to \"complete\" the encounter? The following sorts of goals work well in a big set-piece encounter:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Representing greater demons, devils, vampires, liches, or powerful spellcasters, the champion serves as a boss for 11th-level characters, an elite foe for two 15th-level characters, or a one-on-one challenge against 17th-level characters. This stat block focuses on Charisma.\n\n**CHAMPION**\n\nMedium, Large, or Huge Creature\n\n**Armor Class** 19 (natural armor or magical protection)\n\n**Hit Points** 212 (25d8 + 100)\n\n**Speed** 30 ft.\n\n**Saving Throws** Wis +8, Cha +11\n\n**Skills** Perception +8\n\n**Senses** passive Perception 18\n\n**Challenge** 15 (13,000 XP) **Proficiency Bonus** +5\n\n**ACTIONS**\n\n***Multiattack.*** The champion makes four attacks.\n\n***Attack.*** *Melee or Ranged Weapon Attack:* +11 to hit, reach 5 ft. or range 60 ft., one target. *Hit:* 24 (4d8 + 6) damage."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Once you're in the middle of an encounter, you can make use of a number of other quick tricks to make running monsters easier, with more flexibility and greater speed. Try any of the following options at your table, and make use of any trick that helps your game:\n\nInclude creatures designed to eat \"save or suck\" attacks such as *banishment* or *polymorph*."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              ...
              "table": [
                ...
                [
                  ...
                  "1 Boss + 3 Monsters",
                  "1 Boss + 4 Underlings",
                  "1 Boss + 2 Lieutenants + 8 Minions"
                ],
                [
                  "1",
                  "1",
    ...
    },
    {
      ...
      "intro": "This section offers quick starting points for building encounters, in the form of tables that cover a broad range of foes in twelve types of common adventure location. The tables serve four purposes:",
      "subsections": [
        {
          "id": "default",
          "title": "",
        ...
        {
          "id": "crypts,catacombs,necropolises",
  ...
  "attribution": "This work includes material taken from the [Lazy GM's 5e Monster Builder Resource Document](https://slyflourish.com/lazy_5e_monster_building_resource_document.html) written by Teos Abadía of [Alphastream.org](https://alphastream.org/), Scott Fitzgerald Gray of [Insaneangel.com](https://insaneangel.com/), and Michael E. Shea of [SlyFlourish.com](https://slyflourish.com/), available under a [Creative Commons Attribution 4.0 International License](http://creativecommons.org/licenses/by/4.0/).\n\nThis work includes material taken from the System Reference Document 5.1 (\"SRD 5.1\") by Wizards of the Coast LLC and available at https://dnd.wizards.com/resources/systems-reference-document. The SRD 5.1 is licensed under the Creative Commons Attribution 4.0 International License available at https://creativecommons.org/licenses/by/4.0/legalcode.\n"
};