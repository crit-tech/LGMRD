  ...
  "sections": [
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Finding and maintaining a solid group for roleplaying gaming remains the most difficult task for many GMs. This section offers suggestions for finding players that fit well with your group, and for keeping that group going for years to come."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The first step to building an RPG group is finding players. Some of the most common ways to find players for a group include the following:"
            },
            {
              "type": "table",
              "order": 1,
    ...
    },
    {
      ...
      "subsections": [
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Use these tables to generate a patron or NPC for your adventure, applying an NPC stat block to create villains, hirelings, rivals, or heralds."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Any quests the characters are asked to fulfill might be distilled down to one of the following starting points."
            }
          ],
          "order": 1
        },
        ...
        {
          "id": "locations,monuments,anditems",
          "title": "Locations, Monuments, and Items",
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The location of the quest might also contain specific monuments or items tied to the adventure's goals."
            },
            {
              "type": "table",
              "order": 1,
        ...
        {
          "id": "condition,description,andorigin",
          "title": "Condition, Description, and Origin",
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Locations, monuments, or items can be flavored by determining their condition, description, and origin."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Use this list when you need to define the purpose of a chamber in a dungeon, keep, or similar site. Reflavor any chamber to suit the theme of the adventure."
            }
          ],
          "order": 5
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Add useful discoveries such as the following to your adventure, to create upward beats in the characters' story."
            }
          ],
          "order": 7
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Add traps as they make sense for the adventure. At 1st through 4th level, traps often have a DC of 13, and deal 7 (2d6) damage for easy traps or 11 (2d10) damage for hard traps."
            }
          ],
          "order": 11
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "This list lets you add treasure to the adventure as appropriate. Roll a d10 to determine monetary treasure, or a d20 for monetary and magical treasure."
            }
          ],
          "order": 13
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Some commonly discovered relics might grant a single- use spell, while less common magic items might allow their wielder to cast a spell daily. Use the list of common spells below or choose specialized spells to create unique magic item rewards."
            }
          ],
          "order": 15
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Use character secrets to tie the characters to the world around them. These sorts of secrets might be revealed by NPCs, old journals or letters, suddenly recalled memories, or prophetic dreams."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Use historical secrets to give the characters meaningful and useful information as they explore the setting of the campaign. Secrets of this kind should provide characters and players alike with bite-sized pieces of local or world history.\n\nHistorical secrets might be found as mosaics in ancient tombs, statues in old ruins, dusty tomes in ancient libraries, markings on strange weapons, or tales shared among elderly villagers."
            },
            {
              "type": "table",
              "order": 1,
      ...
      "subsections": [
        {
          ...
          "content": [
            ...
            },
            {
              "type": "paragraph",
              "order": 0,
              "content": "Here's a brief summary of each of the steps."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Before we do anything else, it helps to spend a few minutes reviewing the player characters. What are their names? What do they want? What plays into their backgrounds? What do the players of these characters enjoy at the table?\n\nYou might not even write anything down during this step, but reviewing the characters helps wire them into your mind — and ensures that the rest of your preparation fits around them."
            }
          ],
          "order": 1
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "These steps and processes work just as well whether you interact with your players online or around the table. However you play, the Lazy RPG Prep checklist still works."
            }
          ],
          "order": 9
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "If you have very little time, reduce the checklist to the most important things you can prepare before it's time to run the game. Here are three example steps."
            },
            {
              "type": "table",
              "order": 1,
    ...
    },
    {
      ...
      "intro": "This section helps you build and improvise dynamic combat encounters based on the fiction of the game.",
      "subsections": [
        {
    ...
    },
    {
      "id": "lazysolo5e",
      "title": "Lazy Solo 5e",
      "intro": "These rules let you play a solo game of 5e using lists in this document. With these guidelines, a single character explores a dungeon to complete quests. Let your imagination take over as you fill in the story and details of the quest, location, and adventure.\n\nThis scenario begins at 1st level, and your character gains a level after each successful quest.",
      "subsections": [
        {
          "id": "buildingthequest",
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "When you defeat a monster or enter a chamber with unguarded treasure, roll on the following list:"
            }
          ],
          "order": 5
        },
        {
          ...
          "content": [
            ...
            },
            {
              "type": "paragraph",
              "order": 0,
              "content": "For consumable and permanent items, roll on the tables in the \"[Treasure Generator](treasuregenerator.md)\" section or a random treasure table of your choice. You can replace any consumable magic item with a *potion of healing*. You can replace any permanent magic item with a *+1 weapon* of your choice."
            }
          ],
          "order": 6
        }
    ...
    },
    {
      ...
      "intro": "The following monster templates can help you customize existing monsters into new unique variants that can fit a variety of locations and circumstances. With just a few templates in hand, your core monster books can become much more useful.",
      "subsections": [
        {
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The challenge ratings described in these templates are loose guides, so use your best judgment with them. Apply these templates only when you have a good handle on your characters' capabilities, and be prepared to tune your new monsters accordingly."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Dire monsters are particularly large and dangerous versions of typical monsters, and can be created using the following guidelines:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Infernal or abyssal variants of existing monsters are endlessly spawned across the Lower Planes. This template can turn any monster into a fiendish variant:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Use the following table to choose a random ancestry for your NPC."
            }
          ],
          "order": 1
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "An NPC's worldview can help determine how they initially react to the characters, adjusted by how the characters approach them. Improvise DCs for social interaction ability checks based on that approach, with checks usually ranging between DC 10 (easy) and DC 20 (very hard). A default of DC 12 is usually a good choice."
            }
          ],
          "order": 3
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "NPCs will often be most easily remembered by the players based on some unique aspect of their appearance or manners."
            }
          ],
          "order": 5
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Assign a profession to your NPC to add color to their stat block. The commoner is the default stat block for NPCs of this type."
            }
          ],
          "order": 7
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "In this simple quest design, the characters are hired or conscripted to hunt down a particular monster or villain in a location, then permanently end their threat. The boss might be protected by lieutenants or other minions."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "In this common quest, the characters are sent to a location in order to rescue someone-a captured spy, a wayward prince, a missing child, and so forth. In a variant of this quest, the characters must escort someone to a location, defending them every step of the way."
            }
          ],
          "order": 2
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "With this variant of the \"Find Something\" quest, the characters enter a hostile location to destroy a particular object-an ancient evil obelisk, the catalyst of a dark ritual, a weapon of great power, and so forth."
            }
          ],
          "order": 4
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Award inspiration to each character at the beginning of a session. This takes some of the weight off of needing to remember to reward inspiration during the game. You can still award it again during the game if players have used it."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Index cards can be used to track initiative in two potential ways. First, fold them over into \"table tents\" and number them from 1 to 9. Then hand them out to the players in the order of their characters' initiative. Alternatively, write the characters' names on one side of the card and put character info useful for you on the other. Fold them over the top of your GM screen, then set them out in initiative order each time combat begins."
            }
          ],
          "order": 1
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "For simple battles, use a passive initiative score for monsters, equal to 10 plus the monster's Dexterity bonus. This typically puts monsters in the middle of the initiative order, rather than risking them being too high or too low."
            }
          ],
          "order": 5
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The following tricks make excellent additions to every GM's toolbox:"
            },
            {
              "type": "table",
              "order": 1,
    ...
    },
    {
      ...
      "subsections": [
        ...
        {
          "id": "50monumentstructures",
          "title": "50 Monument Structures",
          "content": [
            {
              "type": "table",
              "order": 0,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The circumstances of the encounter dictate how many members of the horde can attack the characters. Unless the circumstances dictate otherwise, assume the horde evenly spreads its attacks across all characters. If certain characters step ahead of the rest of the party or block choke points that prevent the horde from reaching other characters, you can redirect the horde's attacks to the characters stepping forward."
            }
          ],
          "order": 1
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Adjudicate the number of creatures caught up in an area of effect based on the circumstances, but leaning toward more creatures rather than fewer. You can use the following as a baseline for the number of tightly packed creatures in a horde that are affected in a given area:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The following resources offer further options for RPG safety tools, and influenced the tools described above."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Before your session zero, write out and deliver a one-page campaign guide to your players. Include the following information:\n\nKeep your campaign guide down to a single page so that the players can easily read and absorb it."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Once you and your players are sitting around the table or gathered online for session zero, start by describing the theme of the campaign and going over the details of the one-page campaign guide. Use this time to get the players excited for the campaign."
            }
          ],
          "order": 1
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "A group patron is any NPC tied to all of the characters, and who can help propel the characters forward in an adventure or campaign. Describe potential group patrons that the players can choose from in your campaign, and let them discuss which ones they like. Work toward a consensus where all players are happy with the chosen patron. Don't let this choice alienate any players."
            }
          ],
          "order": 3
        },
    ...
    },
    {
      ...
      "intro": "Spiral campaign development builds campaign worlds starting in the area immediately surrounding the characters, then spirals out, expanding the world as the characters experience it. This section offers suggestions and inspiration for building a spiral campaign.",
      "subsections": [
        {
          "id": "campaignpitch",
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Once you have your pitch, identify six truths that set your campaign apart from others, then share them with your players. Here are six example truths for a campaign built around the coming of the Black Moon from above."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Spiral campaigns begin in a central location, often a small settlement from which the characters set out to explore neighboring lands. A village always works well as a starting location, but there are many alternatives."
            }
          ],
          "order": 3
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "As the campaign spirals outward, the characters will become aware of local adventuring locations. Drop three such adventure locations into the areas close by the starting location. And if you need help filling out an adventure location, look to later sections of this document."
            },
            {
              "type": "table",
              "order": 1,
    ...
    },
    {
      ...
      "subsections": [
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "In a settlement, a strong start can make use of either combat or roleplaying."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "A session that starts in a sewer can make use of numerous monsters and hazards."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Wilderness locations can involve either action or mystery in a strong start."
            },
            {
              "type": "table",
              "order": 1,
        ...
        {
          "id": "dungeons,caves,andcaverns",
          "title": "Dungeons, Caves, and Caverns",
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Subterranean adventures lend themselves to the widest possible range of strong starts."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "For any given task or challenge, ask yourself how hard it is to accomplish. Then assign a DC from 10 (easy) to 20 (very hard). If a task is trivial, don't bother asking for a roll. Rather, the characters automatically succeed. Likewise, reserve DCs above 20 for superhuman challenges."
            }
          ],
          "order": 0
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The following tricks can also help make it easier for you to improvise during your game:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Round-by-round combat played in the theater-of-the-mind style is built around three core principles:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "A GM running a theater-of-the-mind game should keep the following points in mind:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "Players in a theater-of-the-mind game should keep the following points in mind:"
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "As desired, you can augment monetary treasure with consumable magic items from the following table."
            }
          ],
          "order": 1
        },
        {
          ...
          "content": [
            ...
            },
            {
              "type": "paragraph",
              "order": 0,
              "content": "Rather than standard consumable items, you can also award powerful single-use magic items generated using the Spells table from the \"Core Adventure Generator\" included in this document. You can also use the Condition, Description, and Origin table in that section to give an item a unique flavor."
            }
          ],
          "order": 2
        },
    ...
    },
    {
      ...
      "intro": "Death comes to all things, but not even death can keep a good monster down. You can easily create an undead variant of any monster simply by giving it the undead type and describing its undead appearance, letting the narrative feed the players' impression of fighting undead without requiring any mechanical changes. But for even more realistic undead, you can use any of the following templates to give a monster some of the properties and attributes of a specific type of undead creature.",
      "subsections": [
        {
          "id": "undeadtemplates",
          "title": "Undead Templates",
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "All creatures that take on one of these templates gain the following universal changes:\n\nThen apply the traits and actions of any of the following specific templates."
            },
            {
              "type": "table",
              "order": 1,
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "To build variants of creatures modeled after more powerful undead, use the undead creature's stat block and add traits from the base creature. It's easier to apply the traits and actions of a stone giant to a lich or vampire stat block than it is to apply lich or vampire traits to a stone giant stat block."
            }
          ],
          "order": 7
        },
          ...
          "content": [
            {
              "type": "paragraph",
              "order": 0,
              "content": "The following guidelines establish the broad strokes of zone-based combat:"
            },
            {
              "type": "table",
              "order": 1,
