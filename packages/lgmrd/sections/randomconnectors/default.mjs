  ...
  content: [
    {
      ...
      data: [
        ...
        { item_num: 6, item: "Narrow pathway alongside a deep fissure" },
        { item_num: 7, item: "Tunnels illuminated with phosphorescent fungi" },
        ...
        { item_num: 15, item: "Collapsing sinkhole leading to tunnel network" },
        ...
        { item_num: 20, item: "Massive platforms crossing a bottomless pit" },
      ],
    },
  ],
  order: 0,
