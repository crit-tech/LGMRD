  ...
  content: [
    ...
    },
    {
      ...
      data: [
        ...
        { item_num: 2, item: "What makes the NPC think they're right?" },
        { item_num: 3, item: "What was the NPC's great accomplishment?" },
        { item_num: 4, item: "What foe did the NPC defeat?" },
        { item_num: 5, item: "What makes the NPC politically untouchable?" },
        { item_num: 6, item: "What great power does the NPC possess?" },
        { item_num: 7, item: "What does the NPC desire?" },
        { item_num: 8, item: "What regular routines does the NPC follow?" },
        { item_num: 9, item: "Who does the NPC love above all others?" },
        { item_num: 10, item: "What secret does the NPC want to keep hidden?" },
      ],
    },
  ],
  order: 2,
